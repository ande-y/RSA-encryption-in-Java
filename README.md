...
Within the "primes" folder contains 4550 txt files of prime numbers up to 10 billion. This program utilizes this folder & therefore does not need to calculate prime numbers at runtime. Though this program can crack keys at lightning pace, it is limited to cracking keys using prime numbers no larger than 10 billion (~30 bits).
